...
CREATE TABLE trips(
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMEST ON UPDATE CURRENT,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT
);
...
CREATE TABLE photos (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE C,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE C
);
